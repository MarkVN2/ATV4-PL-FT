...
const BarraNavegacao = (props: props) => {
    ...
    useEffect(() => {
        console.log('Barra de navegação renderizada')
    },[])
        return (
            <>
                <nav className="navbar navbar-expand-lg " data-bs-theme="dark" style={{ backgroundColor: 'black', marginBottom: 10 }}>
